  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/3 left-1/4 w-80 h-80 bg-white/3 rounded-full blur-3xl animate-pulse delay-500" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md animate-scale-in">
        <div className="glass shadow-depth-xxl rounded-3xl p-8 space-y-8">
          ...
          <div className="text-center space-y-3 animate-fade-in-up">
            ...
            <h1 className="text-3xl font-bold text-white text-glow">Create Account</h1>
            <p className="text-gray-400 text-sm">Start your AI-powered learning journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-3 animate-fade-in-up delay-500">
              <input
                ...
                id="terms"
                required
                className="mt-1 w-4 h-4 rounded border-white/20 bg-white/5 focus:ring-white/30"
              />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full btn-primary bg-white text-black font-semibold py-3.5 rounded-xl glow-white shadow-depth-lg hover:shadow-depth-xxl disabled:opacity-50 disabled:cursor-not-allowed animate-fade-in-up delay-600"
            >
              {loading ? (
          ...
          {/* Login Link */}
          <p className="text-center text-sm text-gray-400 animate-fade-in-up delay-800">
            Already have an account?{" "}
            <Link href="/login" className="text-white hover:underline font-medium transition-all duration-300 hover:text-glow">
              Sign in
            </Link>
          </p>
        </div>
